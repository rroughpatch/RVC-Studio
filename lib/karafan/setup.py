...
def Install(params):
    ...
    if not params["isColab"]:
        return

    Repository = "https://github.com/Captain-FLAM/KaraFan"
    Version_url = (
        "https://raw.githubusercontent.com/Captain-FLAM/KaraFan/master/App/__init__.py"
    )
    ...
    try:
        ...
        if response.status_code == requests.codes.ok:
            ...
            print(
                "Unable to check version on GitHub ! Maybe you're behind a firewall ?"
            )
            ...
            if DEV_MODE:
                ...
                if os.path.exists(os.path.join(Project, ".git")):
                    try:
                        ...
                        if e.returncode == 127:
                            print(
                                'WARNING : "Git" is not installed on your system !\n'
                                + warning
                            )
                        else:
                            print(
